<html>
	<head>
		...
		<script type="text/javascript" src="js/apbatch.js"></script>
		<script type="text/javascript" src="js/shared/jquery-ui-1.7.2.custom.min.js"></script>
        <script type="text/javascript" src="https://lib-jira.ucsd.edu:8443/s/570923a7ebac454f838812ae4e331542-T/en_USfs3qxk/64016/6/1.4.25/_/download/batch/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector.js?locale=en-US&collectorId=87a63a42"></script>
	</head>
	<body>
		<div class="container">
			<div class="header">
			...
			<div id='actions'>
					<fieldset>
						...
						<p>
							...
							<input type="submit" id="processFile" value="Process out File"/>
			...
			<div class="data_container">
				<div id="editVendors_container">
					<div id="editVendors_grid">
					</div>
					<div id="editVendors_dialogModal">
					</div>
					<div id="editVendors_buttons">
						<input type="submit" id="editVendors_add" value="Add"/>
						<input type="submit" id="editVendors_edit" value="Edit"/>
						<input type="submit" id="editVendors_delete" value="Delete"/>
					</div>
				</div>
				<div id="editIndexes_container">
					<div id="editIndexes_grid">
					</div>
					<div id="editIndexes_dialogModal">
					</div>
					<div id="editIndexes_buttons">
						<input type="submit" id="editIndexes_add" value="Add"/>
						<input type="submit" id="editIndexes_edit" value="Edit"/>
						<input type="submit" id="editIndexes_delete" value="Delete"/>
					</div>
				</div>
				<div id ="indexdiv">
				<div id="title"> </div>
